  ...
  render() {
    ...
    return (
      <div id="game" style={{ width: boardWidthPx }}>
        <h1 className="h1Titulo">Campo Minado</h1>
        <div id="menu">
          <button onClick={this.handleClick} id="restart">Reiniciar</button>
          <DialogButton 
            title="Ajuda" 
            message={'Arrumar mensagem'}
          />
          <select value={difficulty} onChange={(e) => this.changeDifficulty(e)}>
            <option value={'easy'} key={'easy'}>Fácil</option>
            <option value={'normal'} key={'normal'}>Normal</option>
            <option value={'hard'} key={'hard'}>Difícil</option>
            <option value={'veryHard'} key={'veryHard'}>Muito Difícil</option>
            <option value={'maniac'} key={'maniac'}>Michael Douglas</option>
          </select>
        ...
        <div className="divFooter">
          ...
          <p style={{ textAlign: 'right' }}>
            ...
            <a href="https://github.com/ldonizete"> Lucas Donizete</a>
            <br />
            <span>Ver o </span>
            <a href="https://github.com/ldonizete/reactjs-campo-minado"> código</a>
          </p>
        </div>
      </div>
    )
